...
export function OfficerDashboardClient({ initialReports }: OfficerDashboardClientProps) {
    ...
    // In a real app we might re-fetch or use a router refresh, but for now we rely on props + server revalidate
                                            ...
                                            >
                                                ...
                                                <td className="p-3">
                                                    <span className="flex items-center gap-1 text-xs text-[var(--text-muted)]">
                                                        ...
                                                        {/* We might not have a clean location field in Supabase yet, use lat/lng if missing */}
