                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <section className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6" aria-label="Key metrics">
                        <div className="glass-card-static p-3.5">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="flex items-center gap-0.5 text-[10px] text-[var(--success)] font-medium">
                                    <ArrowUp className="w-3 h-3" aria-hidden="true" /> 12%
                                </span>
                            </div>
                        ...
                        <div className="glass-card-static p-3.5">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="flex items-center gap-0.5 text-[10px] text-[var(--success)] font-medium">
                                    <ArrowUp className="w-3 h-3" aria-hidden="true" /> 8%
                                </span>
                            </div>
                        ...
                        <div className="glass-card-static p-3.5">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="flex items-center gap-0.5 text-[10px] text-[var(--error)] font-medium">
                                    <ArrowDown className="w-3 h-3" aria-hidden="true" /> 3%
                                </span>
                            </div>
                        ...
                        <div className="glass-card-static p-3.5">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="flex items-center gap-0.5 text-[10px] text-[var(--success)] font-medium">
                                    <ArrowUp className="w-3 h-3" aria-hidden="true" /> 25%
                                </span>
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-5 mb-6">
                        ...
                        <section className="glass-card-static p-4" aria-labelledby="category-heading">
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-7 h-7 rounded-md bg-[var(--info-bg)] flex items-center justify-center">
                                    <PieChart className="w-3.5 h-3.5 text-[var(--info)]" aria-hidden="true" />
                                </div>
                                <h2 id="category-heading" className="font-medium text-sm text-[var(--text-primary)]">By Category</h2>
                            </div>

                            <div className="space-y-3" role="list" aria-label="Report categories">
                                {categoryData.map(cat => (
                                    <div key={cat.name} role="listitem">
                                        ...
                                        <div
                                            className="h-2 bg-[var(--bg-surface)] rounded-full overflow-hidden"
                                            role="progressbar"
                                            aria-valuenow={cat.count}
                                            aria-valuemax={total}
                                            aria-label={`${cat.name}: ${cat.count} reports`}
                                        >
                                            <div
                        ...
                        <section className="glass-card-static p-4" aria-labelledby="weekly-heading">
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-7 h-7 rounded-md bg-[var(--info-bg)] flex items-center justify-center">
                                    <BarChart3 className="w-3.5 h-3.5 text-[var(--info)]" aria-hidden="true" />
                                </div>
                                <h2 id="weekly-heading" className="font-medium text-sm text-[var(--text-primary)]">Weekly Trend</h2>
                            </div>

                            <div className="flex items-end justify-between h-32 gap-2" role="img" aria-label="Weekly reports bar chart">
                                {weeklyData.map(day => (
                    ...
                    <section className="glass-card-static p-4" aria-labelledby="locations-heading">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-7 h-7 rounded-md bg-[var(--info-bg)] flex items-center justify-center">
                                <TrendingUp className="w-3.5 h-3.5 text-[var(--info)]" aria-hidden="true" />
                            </div>
                            <h2 id="locations-heading" className="font-medium text-sm text-[var(--text-primary)]">Top Areas</h2>
                        </div>

                        <div className="grid grid-cols-2 md:grid-cols-5 gap-2" role="list">
                            {["Koramangala", "Indiranagar", "Whitefield", "HSR Layout", "MG Road"].map((area, i) => (
                                <div
                                    key={area}
                                    className="text-center p-3 rounded-lg bg-[var(--bg-surface)] border border-[var(--glass-border)]"
                                    role="listitem"
                                >
