            ...
            {isOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 z-50 glass-card-static p-1 animate-fade-in shadow-xl">
                    ...
                    >
                        ...
                        <span className={cn(currentStatus === "OPEN" && "font-bold text-[var(--warning)]")}>Open</span>
                    </button>
                    ...
                    >
                        ...
                        <span className={cn(currentStatus === "IN_PROGRESS" && "font-bold text-[var(--info)]")}>In Progress</span>
                    </button>
                    ...
                    >
                        ...
                        <span className={cn(currentStatus === "RESOLVED" && "font-bold text-[var(--success)]")}>Resolved</span>
                    </button>
                    ...
                    >
                        ...
                        <span className={cn(currentPriority === "URGENT" && "font-bold text-[var(--error)]")}>Urgent</span>
                    </button>
                    ...
                    >
                        ...
                        <span className={cn(currentPriority === "HIGH" && "font-bold text-[var(--warning)]")}>High</span>
                    </button>
                </div>
            )}
        </div>
